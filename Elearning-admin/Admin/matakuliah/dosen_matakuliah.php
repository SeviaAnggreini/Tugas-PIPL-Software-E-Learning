<?php
	...
	$query = "SELECT * FROM tbl_dosen_matakuliah WHERE id_matakuliah = '$id_matakuliah' LIMIT ".$limit_start.",".$limit;
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			...
			<a class="btn btn-primary" href="?page=matakuliah&aksi=tambahdatadosen_matakuliah&id=<?php echo $id_matakuliah;?>">Tambah Data</a>
		</h3>
			</div>
									...
									<tr>
										...
										<td>
											<?php 
												...
												$query_matakuliah = "SELECT * FROM tbl_matakuliah WHERE id_matakuliah = '$id_matakuliah'";
												$sql_matakuliah = $pdo->prepare($query_matakuliah);
												$sql_matakuliah->execute();
												$data_matakuliah = $sql_matakuliah->fetch();
												echo $data_matakuliah['nama_matakuliah'];
											?>
										</td>
										<td>
											<?php 
										...
										<td><a onclick="return confirm('Anda akan menghapus data ini?')" class="btn btn-danger" href="?page=matakuliah&aksi=hapusdatadosen_matakuliah&id=<?php echo $data['id_dosen_matakuliah'];?>&matakuliah=<?php echo $data['id_matakuliah'];?>">Delete</a></td>
									</tr>
								</tbody>
								<?php
							}
