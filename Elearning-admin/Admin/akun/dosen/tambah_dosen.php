...
<html>
<head>
	<title>Tambah Dosem</title>
</head>
<body>
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Tambah Dosen</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_dosen&aksi=simpandata_dosen" method="POST">
						...
						<div class="form-group">
							...
							<input class="form-control" name="nama_dosen" required placeholder="Nama Dosen"  required />
						</div>
						<div class="form-group">
