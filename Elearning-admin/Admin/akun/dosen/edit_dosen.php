...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Edit Dosen</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_dosen&aksi=updatedata_dosen" method="POST">
						<div class="form-group">
							<label>Nama Dosen</label>
							<input type="hidden" class="form-control" name="nip" value="<?php echo $data['nip'];?>" required placeholder="NIP Dosen"/>
							<input class="form-control" name="nama_dosen" value="<?php echo $data['nama_dosen'];?>" required placeholder="Nama Dosen"/>
						</div>
						<div class="form-group">
						...
						<a class="btn btn-default" href="?page=akun_dosen&aksi=detail_dosen" style="margin-top:15px">Kembali</a>
					</form>
				</div>
			</div>
		</div>
