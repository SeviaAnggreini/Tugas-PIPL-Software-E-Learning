...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Ganti Password Dosen</strong></h3>
	</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=akun_dosen&aksi=updatepassword_dosen" method="POST">
						<div class="form-group">
							<label>Password Lama</label>
							<input type="hidden" class="form-control" name="email" value="<?php echo $data['email'];?>" required placeholder="email Dosen"/>
						...
						<a class="btn btn-default" href="?page=akun_dosen&aksi=aktif" style="margin-top:15px">Kembali</a>
					</form>
				</div>
			</div>
		</div>
