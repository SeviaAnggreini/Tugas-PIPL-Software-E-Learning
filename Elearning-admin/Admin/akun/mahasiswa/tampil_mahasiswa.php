<?php
	...
	$query = "SELECT * FROM tbl_akun INNER JOIN tbl_mahasiswa ON tbl_akun.nip = tbl_mahasiswa.nim WHERE tbl_akun.hak_akses = 'Mahasiswa' ORDER BY tbl_mahasiswa.prodi ASC, tbl_mahasiswa.nim ASC LIMIT ".$limit_start.",".$limit;
