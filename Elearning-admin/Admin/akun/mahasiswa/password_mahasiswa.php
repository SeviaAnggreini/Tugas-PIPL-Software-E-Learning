...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Ganti Password Mahasiswa</strong></h3>
	</div>
				...
				<div class="col-md-6" >
					<form action="?page=akun_siswa&aksi=updatepassword_siswa" method="POST">
						<div class="form-group">
							...
							<input type="hidden" class="form-control" name="email" value="<?php echo $data['email'];?>" required placeholder="Email Mahasiswa"/>
