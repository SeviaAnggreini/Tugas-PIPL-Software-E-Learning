<?php
	...
	$query = "SELECT * FROM tbl_mahasiswa INNER JOIN tbl_mahasiswa_prodi ON tbl_mahasiswa.nim = tbl_mahasiswa_prodi.nim INNER JOIN tbl_prodi ON tbl_mahasiswa_prodi.id_prodi = tbl_prodi.id_prodi WHERE tbl_mahasiswa_prodi.semester = 'Genap' LIMIT ".$limit_start.",".$limit;
