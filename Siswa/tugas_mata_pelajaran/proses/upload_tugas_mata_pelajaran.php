	...
	if ($jml_tugas == 0) {
		...
		$nama_file = $id_kirim."-".$nis."-".$id_tugas_mata_pelajaran.".".$ekstensi;
			...
			if($sql){
				...
				$user = "976626912";
				$pesan = "Telah Masuk Sebuah Tugas Baru dari E-Learning APLIKASI PENDIDIKAN dengan data NIS : <b>$nis</b> Nama Siswa : <b>$nama_siswa</b> Kelas : <b>$kelas</b> Tugas Mata Pelajaran : <b>$nama_tugas_mapel</b> pada Mata Pelajaran : <b>$nama_mapel</b> Tanggal Kirim : <b>$tgl_kirim</b>. Terimakasih Telah Menyelesaikan Tugas.";
		...
		$nama_file = $id_kirim."-".$nis."-".$id_tugas_mata_pelajaran.".".$ekstensi;
			...
			if($sql){
				$bot = "bot6172324764:AAE7ctRDrBsXANZAWjXnpO72U1CQSpCN8rQ";
				$user = "976626912";
				$pesan = "Telah Masuk Update Sebuah Tugas dari E-Learning APLIKASI PENDIDIKAN dengan data NIS : <b>$nis</b> Nama Siswa : <b>$nama_siswa</b> Kelas : <b>$kelas</b> Tugas Mata Pelajaran : <b>$nama_tugas_mapel</b> pada Mata Pelajaran : <b>$nama_mapel</b> Tanggal Kirim : <b>$tgl_kirim</b>. Terimakasih Telah Menyelesaikan Tugas.";
