<?php 
	...
	foreach ($sheet as $data){
		...
		if($nis == "NIS" && $nama_siswa == "Nama Siswa" && $jenis_kelamin == "Jenis Kelamin" && $tempat_lahir == "Tempat Lahir" && $tanggal_lahir == "Tanggal Lahir" && $alamat == "Alamat" && $no_telp == "No Telp" && $email == "Email" && $kelas == "Kelas"){
			...
			$pesan = "<H4>Akun E-Learning Akademik</H4><br>Telah terdaftar Akun Baru dengan : <br>NIS : ".$nis."<br>Nama Lengkap : ".$nama_siswa."<br>Kelas : ".$kelas."<br>Username : ".$email."<br>Password : ".$pass."<br>Website : ".$web."<br><br>Silahkan digunakan untuk masuk ke Website.<br>Terimakasih.<br><br>TTD<br>E-Learning Akademik APLIKASI PENDIDIKAN";
