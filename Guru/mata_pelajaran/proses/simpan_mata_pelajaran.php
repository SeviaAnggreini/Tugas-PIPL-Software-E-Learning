<?php
	...
	$id_mata_pelajaran = $huruf . sprintf("%05s", $urutan);
		...
		$query = "INSERT INTO tbl_mata_pelajaran (id_mata_pelajaran, nama_mata_pelajaran, jml_jam_mata_pelajaran, semester, kelas) VALUES ('$id_mata_pelajaran', '$nama_mata_pelajaran', '$jml_jam_mata_pelajaran', '$semester', '$kelas')";
