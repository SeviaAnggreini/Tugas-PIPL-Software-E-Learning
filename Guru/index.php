...
<head>
  ...
  <title>APLIKASI SYSTEM E-LEARNING</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?page=nama_kelompok&aksi=aktif"><i class="fa fa-circle-o"></i> Daftar Kelompok</a></li>
            <li><a href="?page=nilai_kel&aksi=aktif"><i class="fa fa-circle-o"></i> Data Nilai Kelompok </a></li>
          </ul>
        </li>
        </li>
        <li>
          <a href="?page=akun_guru&aksi=detail_guru&id=<?php echo $data['nip'];?>">
            ...
            case "beranda":
              ...
              if($aksi=='aktif'){
                ...
                if($aksi=='aktif'){
                  ...
                  if($aksi=='aktif'){
                  include 'nilai_kel/guru/tampil_guru.php';
                } else if ($aksi=='detail_guru') {
                  include 'nilai_kel/guru/rincian_guru.php';
                } else if ($aksi=='tambahdata_guru') {
                  include 'nilai_kel/guru/tambah_guru.php';
                } else if ($aksi=='simpandata_guru') {
                  include 'nilai_kel/guru/proses/simpan_guru.php';
                } else if ($aksi=='editdata_guru') {
                  include 'nilai_kel/guru/edit_guru.php';
                } else if ($aksi=='updatedata_guru') {
                  include 'nilai_kel/guru/proses/update_guru.php';
                } else if ($aksi=='editpassword_guru') {
                  include 'nilai_kel/guru/password_guru.php';
                } else if ($aksi=='updatepassword_guru') {
                  include 'nilai_kel/guru/proses/ganti_password_guru.php';
                } else if ($aksi=='hapusdata_guru') {
                  include 'nilai_kel/guru/proses/hapus_guru.php';
                } else if ($aksi=='import_guru') {
                  include 'nilai_kel/guru/import_guru.php';
                } else if ($aksi=='upload_guru') {
                  include 'nilai_kel/guru/proses/upload_guru.php';
                }
              } 
            }
        ?>
