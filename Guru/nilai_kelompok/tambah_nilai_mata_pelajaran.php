...
<html>
<head>
	<title>Tambah Tugas MataKuliah</title>
</head>
<body>
<div class="panel panel-default">
	<div class="panel-heading">
		<h3><strong>Nilai MataKuliah</strong></h3>
	</div>
			...
			<div class="row">
				<div class="col-md-6" >
					<form action="?page=nilai_mata_pelajaran&aksi=simpandata_tugas_mata_pelajaran" method="POST">
						...
						<div class="form-group">
							<label>Nilai</label>
							<input type="number" class="form-control" name="nilai" required placeholder="Nilai" onkeypress = "return Angkasaja(event)" required />
						</div>
