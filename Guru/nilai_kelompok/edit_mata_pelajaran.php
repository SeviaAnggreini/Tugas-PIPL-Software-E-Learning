<?php
	$id = $_GET['id'];
	$query = "SELECT * FROM tbl_nilai_kel WHERE nama_mahasiswa = '$nama_mahasiswa'";
				...
				<div class="col-md-6" >
					<form action="?page=akun_guru&aksi=updatedata_guru" method="POST">
						<div class="form-group">
							...
							<input type="hidden" class="form-control" name="nip" value="<?php echo $data['nama_mahasiswa'];?>" required placeholder="Nama Mahasiswa"/>
